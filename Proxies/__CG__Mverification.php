...
class Mverification extends \Mverification implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'approved' => [parent::class, 'approved', null, 16],
        ...
        "\0".parent::class."\0".'requestDate' => [parent::class, 'requestDate', null, 16],
        "\0".parent::class."\0".'user' => [parent::class, 'user', null, 16],
        'approved' => [parent::class, 'approved', null, 16],
