...
<div class="container">
    ...
    {/if}
            ...
            <h3>Dati richiesta verifica</h3>
            <p><strong>Data richiesta:</strong> {$verification->getRequestDate()->format('d/m/Y')}</p>
            <p><strong>Descrizione:</strong> {$verification->getDescription()|default:'-'}</p>

            <div style="margin-top:30px;">
                <form method="post" action="/PetHouse/Admin/acceptVerification/{$verification->getId()}" style="display:inline;">
                    <button type="submit" class="btn btn-success">Accetta richiesta</button>
                </form>
                <form method="post" action="/PetHouse/Admin/rejectVerification/{$verification->getId()}" style="display:inline;">
                    <button type="submit" class="btn btn-danger">Rifiuta richiesta</button>
                </form>
            </div>
        </div>
    </div>
