            ...
            <div class="container">
                <div class="row">
                    <div class="page-head-content">
                        <h1 class="page-title">List of users asking for verification</h1>               
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-4">
                    <div class="box-two proerty-item">
                        ...
                        <div class="item-entry">
                            ...
                            <p>Request Reason: {$verifica->getDescription()|default:'-'}</p>
                            <p>Request Date: {$verifica->getRequestDate()->format('d/m/Y')}</p>
                            <a href="/PetHouse/Admin/userProfile/{$user->getId()}" class="btn btn-primary">Show Profile</a>
                        </div>
                    </div>
                </div>
            {/foreach}
