...
<html class="no-js"> <!--<![endif]-->
                ...
                <div class="collapse navbar-collapse yamm" id="navigation">
                    <ul class="main-nav nav navbar-nav navbar-right">
                        ...
                        <div class="text-center" style="margin: 30px 0;">
                            <a href="/PetHouse/" class="btn btn-lg btn-primary" style="border-radius: 25px; font-weight: bold;">
            ...
            <div class="container">
                <div class="row">
                    <div class="page-head-content">
                        <h1 class="page-title">List of Offer for your post</h1>               
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-9  pr0 padding-top-40 properties-page">
                    ...
                    <div class="section"> 
                        <div id="list-type" class="proerty-th-list">
                            {if $offers|@count > 0}
                                {foreach from=$offers item=offer name=offerLoop}
                                    <div class="col-md-4 p0 offer-item" style="display:none;">
                                            ...
                                            <div class="item-entry overflow">
                                                ...
                                                <div class="media" style="margin-top:10px;">
                                                    ...
                                                    <div class="media-body" style="vertical-align:middle;">
                                                        ...
                                                        <span><i class="fa fa-phone"></i> {$client->getTel()}</span><br>
                                                        <a href="/PetHouse/findhosting/viewprofile/{$client->getId()}" class="btn btn-info btn-xs" style="margin-top:5px;font-weight:bold;">
                        ...
                        <div class="text-center" style="margin:20px 0;">
                            ...
                            <select id="offers-per-page" style="margin-left:20px;">
    ...
    <img src="/PetHouse/App/templates/assets/img/icona_footer-3.png" alt="" class="wow pulse" data-wow-delay="1s">
      ...
      <script src="/PetHouse/App/templates/assets/js/modernizr-2.6.2.min.js"></script>
        ...
        <script>
document.addEventListener('DOMContentLoaded', function() {
    var offers = Array.from(document.querySelectorAll('.offer-item'));
    var perPageSelect = document.getElementById('offers-per-page');
    ...
    function showPage(page) {
        var totalPages = Math.ceil(offers.length / perPage) || 1;
        offers.forEach(function(item, idx) {
