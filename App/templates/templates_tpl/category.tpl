                ...
                <div class="col-lg-12">
                  <div class="menu">
                    <div class="first-thumb active">
                      <div class="thumb">
                        <span class="icon"><img src="/PetHouse/App/templates/assets/images/search-icon-01.png" alt=""><h4>Apartments</h4></span>    
                      </div>
                    </div>
                    <div>
                      <div class="thumb">                 
                        <span class="icon"><img src="/PetHouse/App/templates/assets/images/search-icon-02.png" alt=""><h4>Food &amp; Life</h4></span>
                      </div>
                    </div>
                    <div>
                      <div class="thumb">                 
                        <span class="icon"><img src="/PetHouse/App/templates/assets/images/search-icon-03.png" alt=""><h4>Cars</h4></span>
                      </div>
                    </div>
                    <div>
                      <div class="thumb">                 
                        <span class="icon"><img src="/PetHouse/App/templates/assets/images/search-icon-04.png" alt=""><h4>Shopping</h4></span>
                      </div>
                    </div>
                    <div class="last-thumb">
                      <div class="thumb">                 
                        <span class="icon"><img src="/PetHouse/App/templates/assets/images/search-icon-05.png" alt=""><h4>Traveling</h4></span>
                      </div>
                    </div>
                  </div>
                </div> 
                            ...
                            <div class="col-lg-12">
                              <div class="description">
                                <div class="row">
                                  ...
                                  <div class="col-lg-3">
                                    <div class="text-icon">
                                      <h4><img src="/PetHouse/App/templates/assets/images/listing-icon-heading.png" alt=""> Total Listings</h4>
                                    </div>
