            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1 col-sm-6 text-center page-title">
                        <h2 class="error-title">Wrong credentials!</h2>
                        <p>Your credentials seem to be wrong... are you sure you're an admin? 🧐</p>
                        <a href="/PetHouse/admin/login" class="btn btn-default">Return to login page</a>                        
                    </div>
                </div> 
            </div>
        </div> 
