            ...
            <div class="single-property-wrapper">
                ...
                <div class="panel panel-default" style="margin-top:20px;">
                    <div class="panel-heading">
                        <h4 class="panel-title">Dettagli Post</h4>
                    </div>
                    <div class="panel-body">
                        <ul class="list-group" style="margin-bottom:0;">
                            ...
                            <li class="list-group-item">
                                <strong>Animali accettati:</strong><br>
                            ...
                            <li class="list-group-item">
                                <strong>Info aggiuntive:</strong><br>
                            ...
                            <li class="list-group-item">
                                <strong>Segnalazioni totali:</strong>
                ...
                <div class="panel panel-warning" style="margin-top:20px;">
                    <div class="panel-heading">
                        <h4 class="panel-title">Dettagli Segnalazioni</h4>
                    </div>
                    <div class="panel-body">
                        ...
                        {if $reports|@count > 0}
                            <ul class="list-group">
                                {foreach from=$reports item=report}
                                    <li class="list-group-item">
                                        <strong>Descrizione:</strong> {$report->getDescription()}<br>
                                        ...
                                        {else}
                                            <span style="color:#aaa;">Utente sconosciuto</span>
                                        {/if}
                                    </li>
                                {/foreach}
                            </ul>
                    ...
                    <div class="col-md-12 text-center">
                        <form method="post" action="/PetHouse/Admin/approveReportedPost/{$post->getId()}" style="display:inline;">
                            <button type="submit" class="btn btn-success" style="border-radius: 30px; font-weight: bold;">
                                <i class="fa fa-check"></i> Approva post (azzera segnalazioni)
                            </button>
                        </form>
                        <form method="post" action="/PetHouse/Admin/deleteReportedPost/{$post->getId()}" style="display:inline; margin-left:10px;">
                            <button type="submit" class="btn btn-danger" style="border-radius: 30px; font-weight: bold;">
                                <i class="fa fa-trash"></i> Elimina post
                            </button>
                        </form>
                    </div>
                </div>
