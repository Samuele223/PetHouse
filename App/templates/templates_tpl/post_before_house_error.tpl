            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1 col-sm-6 text-center page-title">
                        <h2 class="error-title">You can't create an offer before registering an house ☹️</h2>
                        <p>You can't host someone without an house, can you?</p>
                        <a href="/PetHouse/user/addHouse" class="btn btn-default">Register your house here</a>                        
                    </div>
                </div> 
            </div>
        </div> 
