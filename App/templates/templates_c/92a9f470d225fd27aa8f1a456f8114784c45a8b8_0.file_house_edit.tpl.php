<?php
/* Smarty version 5.5.0, created on 2025-06-25 18:37:09
  from 'file:house_edit.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.0',
  'unifunc' => 'content_685c25b59460d4_88015209',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '92a9f470d225fd27aa8f1a456f8114784c45a8b8' => 
    array (
      0 => 'house_edit.tpl',
      1 => 1750868230,
      2 => 'file',
...
function content_685c25b59460d4_88015209 (\Smarty\Template $_smarty_tpl) {
                ...
                <div class="clearfix" > 
                    <div class="wizard-container"> 
                        ...
                        <div class="wizard-card ct-wizard-orange" id="wizardProperty">
                            ...
                            <form id="houseForm" action="/PetHouse/user/updateHouse/<?php echo $_smarty_tpl->getValue('house')->getId();?>
" method="post" enctype="multipart/form-data">             
                                <div class="wizard-header">
                                    <h3>
                                        <b>EDIT</b> YOUR HOUSE <br>
                                        <small>é sempre tempo di una bella rinfrescata</small>
                                    </h3>
                                </div>
                                        ...
                                        <div class="row p-b-15  ">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="title" type="text" class="form-control" value="<?php echo $_smarty_tpl->getValue('house')->getTitle();?>
">
                                                </div>
                                            ...
                                            <div class="col-sm-12"> 
                                                <div class="col-sm-12"> 
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="description" class="form-control" value="<?php echo $_smarty_tpl->getValue('house')->getDescription();?>
"></textarea>
                                                    </div> 
                                                </div> 
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="province" class="form-control" value="<?php echo $_smarty_tpl->getValue('house')->getProvince();?>
"">
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="city" class="form-control" value="<?php echo $_smarty_tpl->getValue('house')->getCity();?>
"">
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label>Country :</label>
                                                        <input type="text" name="country" class="form-control" value="<?php echo $_smarty_tpl->getValue('house')->getCountry();?>
"">
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <label>Address :</label>
                                                        <input type="text" name="address" class="form-control" value="<?php echo $_smarty_tpl->getValue('house')->getAddress();?>
"">
                                                    </div>
                                                </div>
                                            </div>
