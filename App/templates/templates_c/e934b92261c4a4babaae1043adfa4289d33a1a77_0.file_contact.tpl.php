<?php
/* Smarty version 5.5.0, created on 2025-06-20 16:55:03
  from 'file:contact.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.0',
  'unifunc' => 'content_685576476fb2a2_96750787',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e934b92261c4a4babaae1043adfa4289d33a1a77' => 
    array (
      0 => 'contact.tpl',
      1 => 1750431271,
      2 => 'file',
...
function content_685576476fb2a2_96750787 (\Smarty\Template $_smarty_tpl) {
...
<body>
        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li><a href="/PetHouse/App/templates/templates_tpl/contact.tpl" class="active">Contact Us</a></li> 
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4">
          <div class="about">
            <div class="logo">
              <img src="/PetHouse/App/templates/assets/images/black-logo.png" alt="Plot Listing Template">
            </div>
  ...
  <!-- Scripts -->
  <?php echo '<script'; ?>
 src="/PetHouse/App/templates/vendor/jquery/jquery.min.js"><?php echo '</script'; ?>
>
  <?php echo '<script'; ?>
 src="/PetHouse/App/templates/vendor/bootstrap/js/bootstrap.bundle.min.js"><?php echo '</script'; ?>
>
  <?php echo '<script'; ?>
 src="/PetHouse/App/templates/assets/js/owl-carousel.js"><?php echo '</script'; ?>
>
  <?php echo '<script'; ?>
 src="/PetHouse/App/templates/assets/js/animation.js"><?php echo '</script'; ?>
>
  <?php echo '<script'; ?>
 src="/PetHouse/App/templates/assets/js/imagesloaded.js"><?php echo '</script'; ?>
>
  <?php echo '<script'; ?>
 src="/PetHouse/App/templates/assets/js/custom.js"><?php echo '</script'; ?>
>
